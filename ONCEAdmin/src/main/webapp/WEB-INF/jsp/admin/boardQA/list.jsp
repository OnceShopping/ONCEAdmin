									...
									<ul class="nav nav-main">
										...
										<li><a
											...
											class="auto"> <span class="pull-right text-muted"><i
													...
													class="i i-circle-sm text-active"></i> </span> <i
												class="i i-grid2 icon"> </i> <span class="font-bold">고객
													관리</span>
										</a></li>
									</ul>
								</nav>
				...
				<section id="content">
					<section class="vbox">
						<section class="scrollable wrapper" style="padding-left: 50px">
							...
							<select id="selectCategory3" class="form-control " style="width: 150px; margin-right: 200px" name="selectCategory3">
