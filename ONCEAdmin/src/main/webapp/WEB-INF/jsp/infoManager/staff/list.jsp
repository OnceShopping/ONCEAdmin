...
<body class="">
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
		 	...
		 	<div class="modal-body">
		 		<div id="searchResult">검색 란을 입력해 주세요</div>
			</div>
	...
	<div id="dialog-pwd" title="CHECK PASSWORD">
	  	<p class="validateTips">본인 확인을 위해서 비밀 번호를 다시 한번 입력해 주세요</p>
	 	<form>
		    <fieldset>
                     ...
                     <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
                        ...
                        <nav class="nav-primary hidden-xs" id="sidemenu">
                           ...
                           <ul class="nav nav-main" data-ride="collapse">
                              ...
                              <li class="active"><a href="${pageContext.request.contextPath}/info/staffList" class="auto"><span
